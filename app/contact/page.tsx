            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      <a href="tel:+13175551234" className="hover:text-primary">
                        (317) 555-1234
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      <a href="mailto:info@nazindy.org" className="hover:text-primary">
                        info@nazindy.org
                      </a>
                    </p>
                  </div>
              ...
              <div className="mt-10">
                ...
                <div className="space-y-3">
                  <div>
                    <h4 className="font-medium">Sunday School</h4>
                    <p className="text-muted-foreground">9:00 AM - 10:15 AM</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Sunday Worship</h4>
                    <p className="text-muted-foreground">10:30 AM - 12:00 PM</p>
                  </div>
                  <div>
                    <h4 className="font-medium">Wednesday Bible Study</h4>
                    <p className="text-muted-foreground">7:00 PM - 8:30 PM</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-10">
                ...
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-200 hover:bg-gray-300 p-3 rounded-full">
